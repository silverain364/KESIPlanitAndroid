...
import com.example.kesi.ui.community.chat.ChatActivity
...
class AddGroupActivity : AppCompatActivity() {
    ...
    private val friendsApi = retrofit.create(com.example.kesi.data.remote.FriendsApi::class.java)
    private val groupApi = retrofit.create(com.example.kesi.data.remote.GroupApi::class.java)
    val friendsList = ArrayList<com.example.kesi.data.model.FriendsDto>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        friendsApi.getFriends().enqueue(object : Callback<List<com.example.kesi.data.model.FriendsDto>> {
            override fun onResponse(p0: Call<List<com.example.kesi.data.model.FriendsDto>>, response: Response<List<com.example.kesi.data.model.FriendsDto>>) {
                response.body()?.let {
                    friends ->
                    friendsList.clear()
            ...
            override fun onFailure(p0: Call<List<com.example.kesi.data.model.FriendsDto>>, p1: Throwable) {
        ...
        binding.btnCreateGroup.setOnClickListener {
            ...
            val groupMakeInfoRequestDto =
                com.example.kesi.data.model.GroupMakeInfoRequestDto(inviteUserEmails, groupName)
            // 그룹 생성(서버)
