package com.example.kesi.ui.home
...
import com.example.kesi.ui.common.calendar.FullCalendarHolder
...
class SpaceCalendar(
    ...
    fun editSchedule(editScheduleDto: EditScheduleDto) {
        ...
        scheduleApi.updateSchedule(com.example.kesi.data.model.RequestPersonalUpdateScheduleDto.from(schedule)).enqueue(object :
            Callback<com.example.kesi.data.model.ScheduleDto> {
            override fun onResponse(p0: Call<com.example.kesi.data.model.ScheduleDto>, p1: Response<com.example.kesi.data.model.ScheduleDto>) {
            ...
            override fun onFailure(p0: Call<com.example.kesi.data.model.ScheduleDto>, p1: Throwable) {
     ...
     fun addSchedule(addScheduleDto: AddScheduleDto) {
        ...
        scheduleApi.addSchedule(com.example.kesi.data.model.RequestPersonalScheduleDto.toDto(addScheduleDto)).enqueue(object: Callback<Long> {
