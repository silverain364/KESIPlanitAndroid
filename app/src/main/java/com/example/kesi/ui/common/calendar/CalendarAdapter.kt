        ...
        fun bind(date: LocalDate) {
            ...
            for (i in 1..firstDay) {
                calendarAdapter.addItem(
                    com.example.kesi.data.model.CalendarBoxDto(
                        lastMonthLastDay - firstDay + i,
                        com.example.kesi.data.model.CalendarBoxDto.LAST_MONTH
                    )
                )
            }
            ...
            for (i in 1..date.lengthOfMonth()) {
                calendarAdapter.addItem(
                    com.example.kesi.data.model.CalendarBoxDto(
                        i,
                        com.example.kesi.data.model.CalendarBoxDto.NOW_MONTH
                    )
                )
            }
            ...
            for (i in 1..(35 - (date.lengthOfMonth() + firstDay))) {
                calendarAdapter.addItem(
                    com.example.kesi.data.model.CalendarBoxDto(
                        i,
                        com.example.kesi.data.model.CalendarBoxDto.NEXT_MONTH
                    )
                )
            }
